...
public partial class PreviewRenderingViewport : SubViewport
{
	...
	public void SetPreviewNode(PackedScene scene, Perspective previewPerspective)
	{
		_previewNode?.QueueFree();
		PreviewNodeSetup(scene, previewPerspective);
	}

	private void PreviewNodeSetup(PackedScene scene, Perspective previewPerspective)
	{
		var node = scene.Instantiate(); // TODO: use threading for this instantiation
